...
Property_Data_by_Region_Year <- Property_Data_by_Region_Year %>%
  ...
  mutate(Total_Property_Value = Total_Property_Value * Cumulative_Inflation / Economic_Data_Work$Cumulative_Inflation[Economic_Data_Work$Year == 2021]) %>%
  dplyr::select(c("Region","Year","Total_Property_Value"))
...
Hazard_Data_H_Cluster_Distribution_Parameters <- Hazard_Data_H_Cluster %>%
  ...
  distinct(Region,Hazard.Event..Grouped.,Cluster, .keep_all = TRUE) %>%
  mutate(Scale = 
           case_when(
  ...
  arrange(Region,Hazard.Event..Grouped.)
...
# Minor
# Region 1
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 1) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_1_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                           distr = "gamma",
                                           method = "mle",
                                           start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                        shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_1_fitdist)
plot(Hazard_Data_Minor_Region_1_fitdist)

# Region 2
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 2) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_2_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_2_fitdist)
plot(Hazard_Data_Minor_Region_2_fitdist)

# Region 3
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 3) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_3_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_3_fitdist)
plot(Hazard_Data_Minor_Region_3_fitdist)

# Region 4
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 4) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_4_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_4_fitdist)
plot(Hazard_Data_Minor_Region_4_fitdist)

# Region 5
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 5) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_5_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_5_fitdist)
plot(Hazard_Data_Minor_Region_5_fitdist)

# Region 6
Hazard_Data_Minor <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 6) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Minor_Region_6_fitdist <- fitdist(Hazard_Data_Minor$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Minor$Property.Damage_Exposure)/mean(Hazard_Data_Minor$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Minor$Property.Damage_Exposure)^2/var(Hazard_Data_Minor$Property.Damage_Exposure)))
summary(Hazard_Data_Minor_Region_6_fitdist)
plot(Hazard_Data_Minor_Region_6_fitdist)



# Medium
# Region 1
Hazard_Data_Medium <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>500000 & Property.Damage_Exposure<=5000000 & Region == 1) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Medium_Region_1_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_1_fitdist)
plot(Hazard_Data_Medium_Region_1_fitdist)
...
Hazard_Data_Medium_Region_2_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_2_fitdist)
plot(Hazard_Data_Medium_Region_2_fitdist)
...
Hazard_Data_Medium_Region_3_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_3_fitdist)
plot(Hazard_Data_Medium_Region_3_fitdist)
...
Hazard_Data_Medium_Region_4_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_4_fitdist)
plot(Hazard_Data_Medium_Region_4_fitdist)
...
Hazard_Data_Medium_Region_5_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_5_fitdist)
plot(Hazard_Data_Medium_Region_5_fitdist)
...
Hazard_Data_Medium_Region_6_fitdist <- fitdist(Hazard_Data_Medium$Property.Damage_Exposure,
                                              distr = "gamma",
                                              method = "mle",
                                              start = list(scale = var(Hazard_Data_Medium$Property.Damage_Exposure)/mean(Hazard_Data_Medium$Property.Damage_Exposure),
                                                           shape = mean(Hazard_Data_Medium$Property.Damage_Exposure)^2/var(Hazard_Data_Medium$Property.Damage_Exposure)))
summary(Hazard_Data_Medium_Region_6_fitdist)
plot(Hazard_Data_Medium_Region_6_fitdist)



# Major
# Region 1
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 1) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_1_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_1_fitdist)
plot(Hazard_Data_Major_Region_1_fitdist)

# Region 2
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 2) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_2_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_2_fitdist)
plot(Hazard_Data_Major_Region_2_fitdist)

# Region 3
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 3) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_3_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_3_fitdist)
plot(Hazard_Data_Major_Region_3_fitdist)

# Region 4
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 4) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_4_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_4_fitdist)
plot(Hazard_Data_Major_Region_4_fitdist)

# Region 5
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 5) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_5_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_5_fitdist)
plot(Hazard_Data_Major_Region_5_fitdist)

# Region 6
Hazard_Data_Major <- Hazard_Data_H_Cluster %>%
  filter(Property.Damage_Exposure>5000000& Region == 6) %>%
  arrange(Property.Damage_Exposure)

Hazard_Data_Major_Region_6_fitdist <- fitdist(Hazard_Data_Major$Property.Damage_Exposure,
                                               distr = "gamma",
                                               method = "mle",
                                               start = list(scale = var(Hazard_Data_Major$Property.Damage_Exposure)/mean(Hazard_Data_Major$Property.Damage_Exposure),
                                                            shape = mean(Hazard_Data_Major$Property.Damage_Exposure)^2/var(Hazard_Data_Major$Property.Damage_Exposure)))
summary(Hazard_Data_Major_Region_6_fitdist)
plot(Hazard_Data_Major_Region_6_fitdist)



Hazard_Data_Event_Size_Distribution_Parameters <- data.frame(Size = rep(c("Minor", "Medium", "Major"),c(6,6,6)), Region = rep(c(1,2,3,4,5,6),3)) %>%
  mutate(Scale = case_when(
    Size == "Minor" & Region == "1" ~ Hazard_Data_Minor_Region_1_fitdist$estimate['scale'],
    Size == "Minor" & Region == "2" ~ Hazard_Data_Minor_Region_2_fitdist$estimate['scale'],
    Size == "Minor" & Region == "3" ~ Hazard_Data_Minor_Region_3_fitdist$estimate['scale'],
    Size == "Minor" & Region == "4" ~ Hazard_Data_Minor_Region_4_fitdist$estimate['scale'],
    Size == "Minor" & Region == "5" ~ Hazard_Data_Minor_Region_5_fitdist$estimate['scale'],
    Size == "Minor" & Region == "6" ~ Hazard_Data_Minor_Region_6_fitdist$estimate['scale'],
    Size == "Medium" & Region == "1" ~ Hazard_Data_Medium_Region_1_fitdist$estimate['scale'],
    Size == "Medium" & Region == "2" ~ Hazard_Data_Medium_Region_2_fitdist$estimate['scale'],
    Size == "Medium" & Region == "3" ~ Hazard_Data_Medium_Region_3_fitdist$estimate['scale'],
    Size == "Medium" & Region == "4" ~ Hazard_Data_Medium_Region_4_fitdist$estimate['scale'],
    Size == "Medium" & Region == "5" ~ Hazard_Data_Medium_Region_5_fitdist$estimate['scale'],
    Size == "Medium" & Region == "6" ~ Hazard_Data_Medium_Region_6_fitdist$estimate['scale'],
    Size == "Major" & Region == "1" ~ Hazard_Data_Major_Region_1_fitdist$estimate['scale'],
    Size == "Major" & Region == "2" ~ Hazard_Data_Major_Region_2_fitdist$estimate['scale'],
    Size == "Major" & Region == "3" ~ Hazard_Data_Major_Region_3_fitdist$estimate['scale'],
    Size == "Major" & Region == "4" ~ Hazard_Data_Major_Region_4_fitdist$estimate['scale'],
    Size == "Major" & Region == "5" ~ Hazard_Data_Major_Region_5_fitdist$estimate['scale'],
    Size == "Major" & Region == "6" ~ Hazard_Data_Major_Region_6_fitdist$estimate['scale']
  )) %>%
  mutate(Shape = case_when(
    Size == "Minor" & Region == "1" ~ Hazard_Data_Minor_Region_1_fitdist$estimate['shape'],
    Size == "Minor" & Region == "2" ~ Hazard_Data_Minor_Region_2_fitdist$estimate['shape'],
    Size == "Minor" & Region == "3" ~ Hazard_Data_Minor_Region_3_fitdist$estimate['shape'],
    Size == "Minor" & Region == "4" ~ Hazard_Data_Minor_Region_4_fitdist$estimate['shape'],
    Size == "Minor" & Region == "5" ~ Hazard_Data_Minor_Region_5_fitdist$estimate['shape'],
    Size == "Minor" & Region == "6" ~ Hazard_Data_Minor_Region_6_fitdist$estimate['shape'],
    Size == "Medium" & Region == "1" ~ Hazard_Data_Medium_Region_1_fitdist$estimate['shape'],
    Size == "Medium" & Region == "2" ~ Hazard_Data_Medium_Region_2_fitdist$estimate['shape'],
    Size == "Medium" & Region == "3" ~ Hazard_Data_Medium_Region_3_fitdist$estimate['shape'],
    Size == "Medium" & Region == "4" ~ Hazard_Data_Medium_Region_4_fitdist$estimate['shape'],
    Size == "Medium" & Region == "5" ~ Hazard_Data_Medium_Region_5_fitdist$estimate['shape'],
    Size == "Medium" & Region == "6" ~ Hazard_Data_Medium_Region_6_fitdist$estimate['shape'],
    Size == "Major" & Region == "1" ~ Hazard_Data_Major_Region_1_fitdist$estimate['shape'],
    Size == "Major" & Region == "2" ~ Hazard_Data_Major_Region_2_fitdist$estimate['shape'],
    Size == "Major" & Region == "3" ~ Hazard_Data_Major_Region_3_fitdist$estimate['shape'],
    Size == "Major" & Region == "4" ~ Hazard_Data_Major_Region_4_fitdist$estimate['shape'],
    Size == "Major" & Region == "5" ~ Hazard_Data_Major_Region_5_fitdist$estimate['shape'],
    Size == "Major" & Region == "6" ~ Hazard_Data_Major_Region_6_fitdist$estimate['shape']
  ))


write.csv(Hazard_Data_Event_Size_Distribution_Parameters, "C:/Users/Winson/Documents/UNSW/ACTL4001/Case Study/Working/Severity_Modelling_2.csv", row.names = FALSE)
